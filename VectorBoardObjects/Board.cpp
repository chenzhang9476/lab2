...
void Board::move(char command)
{
	if ('p' != command)
	{
				...
				else
		{
			...
			{
				mySpace[player_id_x][player_id_y]->elimiantePlayer();
				player_id_x--;
		...
		int cookieValue = mySpace[player_id_x][player_id_y]->cookieValue();
		if (cookieValue > 0)
		{
